...
| `pd-researcher` 的取证 | [`research`](https://raw.githubusercontent.com/mattpocock/skills/main/skills/engineering/research/SKILL.md) |
| `pd-spec-e` 的 SPEC 格式 | [`to-spec`](https://raw.githubusercontent.com/mattpocock/skills/main/skills/engineering/to-spec/SKILL.md)，已内化为 `pd-spec-e/spec-format.md` |
...
| 四个负责人的会话交接 | [`handoff`](https://raw.githubusercontent.com/mattpocock/skills/main/skills/productivity/handoff/SKILL.md) |
...
4. **`to-spec` 的单文档形态**（what/why 与 how 同在一份）让本项目取消了 PRD 与 design.md 两份文档，交付件从 3 份收敛到 1 份。
...
- `to-spec` 与 `to-tickets` 的**语义**被改写内化成本项目自己的格式文档（`pd-spec-e/spec-format.md`、`dm/templates.md`），并在文中注明出处。
